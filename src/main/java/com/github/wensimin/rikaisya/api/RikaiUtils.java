...
public class RikaiUtils {
    ...
    // url正则
    private static final String URL_REX = "(https?|ss|vmess|ftp)://(www\\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\\.[a-zA-Z0-9()]{1,6}\\b([-a-zA-Z0-9()@:%_+.~#?&/=]*)";
    // ip正则
    ...
    static {
        ...
        METHODS.add(new RikaiMethod(RikaiType.tag, Pattern.compile(TAG_REX), s -> s.substring(1, s.length() - 1)));
    }
